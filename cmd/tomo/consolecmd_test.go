...
const (
	ipcAPIs  = "admin:1.0 debug:1.0 eth:1.0 miner:1.0 net:1.0 personal:1.0 posv:1.0 rpc:1.0 janot:1.0 janotlending:1.0 txpool:1.0 web3:1.0"
...
func TestConsoleWelcome(t *testing.T) {
	...
	tomo := runTomo(t,
		"--janot.datadir", tmpdir(t)+"janot/"+time.Now().String(),
