...
import (
	...
	"github.com/janetachain/janetachain/contracts/blocksigner/contract"
	randomizeContract "github.com/janetachain/janetachain/contracts/randomize/contract"
...
func GetRandomizeFromContract(client bind.ContractBackend, addrMasternode common.Address) (int64, error) {
	randomize, err := randomizeContract.NewJanetaRandomize(common.HexToAddress(common.RandomizeSMC), client)
	if err != nil {
