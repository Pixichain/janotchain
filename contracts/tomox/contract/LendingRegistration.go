...
// LAbstractJanoTListingABI is the input ABI used to generate the binding from.
const LAbstractJanoTListingABI = "[{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"}],\"name\":\"getTokenStatus\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"

// LAbstractJanoTListingBin is the compiled bytecode used for deploying new contracts.
const LAbstractJanoTListingBin = `0x`

// DeployLAbstractJanoTListing deploys a new Ethereum contract, binding an instance of LAbstractJanoTListing to it.
func DeployLAbstractJanoTListing(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *LAbstractJanoTListing, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractJanoTListingABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(LAbstractJanoTListingBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &LAbstractJanoTListing{LAbstractJanoTListingCaller: LAbstractJanoTListingCaller{contract: contract}, LAbstractJanoTListingTransactor: LAbstractJanoTListingTransactor{contract: contract}, LAbstractJanoTListingFilterer: LAbstractJanoTListingFilterer{contract: contract}}, nil
}

// LAbstractJanoTListing is an auto generated Go binding around an Ethereum contract.
type LAbstractJanoTListing struct {
	LAbstractJanoTListingCaller     // Read-only binding to the contract
	LAbstractJanoTListingTransactor // Write-only binding to the contract
	LAbstractJanoTListingFilterer   // Log filterer for contract events
}

// LAbstractJanoTListingCaller is an auto generated read-only Go binding around an Ethereum contract.
type LAbstractJanoTListingCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractJanoTListingTransactor is an auto generated write-only Go binding around an Ethereum contract.
type LAbstractJanoTListingTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractJanoTListingFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type LAbstractJanoTListingFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractJanoTListingSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type LAbstractJanoTListingSession struct {
	Contract     *LAbstractJanoTListing // Generic contract binding to set the session for
	CallOpts     bind.CallOpts          // Call options to use throughout this session
	TransactOpts bind.TransactOpts      // Transaction auth options to use throughout this session
}

// LAbstractJanoTListingCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type LAbstractJanoTListingCallerSession struct {
	Contract *LAbstractJanoTListingCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts                // Call options to use throughout this session
}

// LAbstractJanoTListingTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type LAbstractJanoTListingTransactorSession struct {
	Contract     *LAbstractJanoTListingTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts                // Transaction auth options to use throughout this session
}

// LAbstractJanoTListingRaw is an auto generated low-level Go binding around an Ethereum contract.
type LAbstractJanoTListingRaw struct {
	Contract *LAbstractJanoTListing // Generic contract binding to access the raw methods on
}

// LAbstractJanoTListingCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type LAbstractJanoTListingCallerRaw struct {
	Contract *LAbstractJanoTListingCaller // Generic read-only contract binding to access the raw methods on
}

// LAbstractJanoTListingTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type LAbstractJanoTListingTransactorRaw struct {
	Contract *LAbstractJanoTListingTransactor // Generic write-only contract binding to access the raw methods on
}

// NewLAbstractJanoTListing creates a new instance of LAbstractJanoTListing, bound to a specific deployed contract.
func NewLAbstractJanoTListing(address common.Address, backend bind.ContractBackend) (*LAbstractJanoTListing, error) {
	contract, err := bindLAbstractJanoTListing(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &LAbstractJanoTListing{LAbstractJanoTListingCaller: LAbstractJanoTListingCaller{contract: contract}, LAbstractJanoTListingTransactor: LAbstractJanoTListingTransactor{contract: contract}, LAbstractJanoTListingFilterer: LAbstractJanoTListingFilterer{contract: contract}}, nil
}

// NewLAbstractJanoTListingCaller creates a new read-only instance of LAbstractJanoTListing, bound to a specific deployed contract.
func NewLAbstractJanoTListingCaller(address common.Address, caller bind.ContractCaller) (*LAbstractJanoTListingCaller, error) {
	contract, err := bindLAbstractJanoTListing(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractJanoTListingCaller{contract: contract}, nil
}

// NewLAbstractJanoTListingTransactor creates a new write-only instance of LAbstractJanoTListing, bound to a specific deployed contract.
func NewLAbstractJanoTListingTransactor(address common.Address, transactor bind.ContractTransactor) (*LAbstractJanoTListingTransactor, error) {
	contract, err := bindLAbstractJanoTListing(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractJanoTListingTransactor{contract: contract}, nil
}

// NewLAbstractJanoTListingFilterer creates a new log filterer instance of LAbstractJanoTListing, bound to a specific deployed contract.
func NewLAbstractJanoTListingFilterer(address common.Address, filterer bind.ContractFilterer) (*LAbstractJanoTListingFilterer, error) {
	contract, err := bindLAbstractJanoTListing(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &LAbstractJanoTListingFilterer{contract: contract}, nil
}

// bindLAbstractJanoTListing binds a generic wrapper to an already deployed contract.
func bindLAbstractJanoTListing(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractJanoTListingABI))
	if err != nil {
		return nil, err
	}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractJanoTListing *LAbstractJanoTListingRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractJanoTListing.Contract.LAbstractJanoTListingCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractJanoTListing *LAbstractJanoTListingRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractJanoTListing.Contract.LAbstractJanoTListingTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractJanoTListing *LAbstractJanoTListingRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractJanoTListing.Contract.LAbstractJanoTListingTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractJanoTListing *LAbstractJanoTListingCallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractJanoTListing.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractJanoTListing *LAbstractJanoTListingTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractJanoTListing.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractJanoTListing *LAbstractJanoTListingTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractJanoTListing.Contract.contract.Transact(opts, method, params...)
}
...
func (_LAbstractJanoTListing *LAbstractJanoTListingCaller) GetTokenStatus(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0
	err := _LAbstractJanoTListing.contract.Call(opts, out, "getTokenStatus", arg0)
	return *ret0, err
}
...
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractJanoTListing *LAbstractJanoTListingSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractJanoTListing.Contract.GetTokenStatus(&_LAbstractJanoTListing.CallOpts, arg0)
}

// GetTokenStatus is a free data retrieval call binding the contract method 0xa3ff31b5.
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractJanoTListing *LAbstractJanoTListingCallerSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractJanoTListing.Contract.GetTokenStatus(&_LAbstractJanoTListing.CallOpts, arg0)
}
...
// JanotListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function JanotListing() constant returns(address)
func (_Lending *LendingCaller) JanotListing(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _Lending.contract.Call(opts, out, "JanotListing")
	return *ret0, err
}
...
//
// Solidity: function JanotListing() constant returns(address)
func (_Lending *LendingSession) JanotListing() (common.Address, error) {
	return _Lending.Contract.JanotListing(&_Lending.CallOpts)
}

// JanotListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function JanotListing() constant returns(address)
func (_Lending *LendingCallerSession) JanotListing() (common.Address, error) {
	return _Lending.Contract.JanotListing(&_Lending.CallOpts)
}
