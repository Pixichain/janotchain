...
import (
	...
	"github.com/janetachain/janetachain/janotlending/lendingstate"
	"math/big"
	"os"
	"time"
...
func main() {
	...
	lendContract, _ := janot.NewLendingRelayerRegistration(auth, common.HexToAddress(os.Getenv("LENDING_ADDRESS")), client)
