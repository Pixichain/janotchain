...
import (
	...
	"github.com/janetachain/janetachain/contracts/randomize/contract"
)

type Randomize struct {
	*contract.JanetaRandomizeSession
...
func NewRandomize(transactOpts *bind.TransactOpts, contractAddr common.Address, contractBackend bind.ContractBackend) (*Randomize, error) {
	randomize, err := contract.NewJanetaRandomize(contractAddr, contractBackend)
	if err != nil {
		return nil, err
	}
...
func DeployRandomize(transactOpts *bind.TransactOpts, contractBackend bind.ContractBackend) (common.Address, *Randomize, error) {
	randomizeAddr, _, _, err := contract.DeployJanetaRandomize(transactOpts, contractBackend)
	if err != nil {
