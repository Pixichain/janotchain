...
func TestUDP_packetErrors(t *testing.T) {
	...
	test.packetIn(errExpired, pingJaneta, &ping{From: testRemote, To: testLocalAnnounced, Version: Version})
...
func TestUDP_successfulPing(t *testing.T) {
	...
	go test.packetIn(nil, pingJaneta, &ping{From: testRemote, To: testLocalAnnounced, Version: Version, Expiration: futureExp})
