...
import (
	...
	"github.com/janetachain/janetachain/janotlending"

	"github.com/janetachain/janetachain/accounts/abi/bind"
	"github.com/janetachain/janetachain/common/hexutil"
	"github.com/janetachain/janetachain/core/state"
	"github.com/janetachain/janetachain/eth/filters"
	"github.com/janetachain/janetachain/rlp"

	"bytes"

	"github.com/janetachain/janetachain/accounts"
	"github.com/janetachain/janetachain/common"
	"github.com/janetachain/janetachain/consensus"
	"github.com/janetachain/janetachain/consensus/ethash"
	"github.com/janetachain/janetachain/consensus/posv"
	"github.com/janetachain/janetachain/contracts"
	contractValidator "github.com/janetachain/janetachain/contracts/validator/contract"
	"github.com/janetachain/janetachain/core"
	"github.com/janetachain/janetachain/core/bloombits"

	//"github.com/janetachain/janetachain/core/state"
	"github.com/janetachain/janetachain/core/types"
	"github.com/janetachain/janetachain/core/vm"
	"github.com/janetachain/janetachain/eth/downloader"
	"github.com/janetachain/janetachain/eth/gasprice"
	"github.com/janetachain/janetachain/ethdb"
	"github.com/janetachain/janetachain/event"
	"github.com/janetachain/janetachain/internal/ethapi"
	"github.com/janetachain/janetachain/log"
	"github.com/janetachain/janetachain/miner"
	"github.com/janetachain/janetachain/node"
	"github.com/janetachain/janetachain/p2p"
	"github.com/janetachain/janetachain/params"
	"github.com/janetachain/janetachain/rpc"
	"github.com/janetachain/janetachain/janot"
)
...
func New(ctx *node.ServiceContext, config *Config, janoTServ *janot.JanoT, lendingServ *janotlending.Lending) (*Ethereum, error) {
	...
	// Inject JanoT Service into main Eth Service.
	if janoTServ != nil {
		eth.JanoT = janoTServ
	}
	if lendingServ != nil {
	...
	if eth.chainConfig.Posv != nil {
		...
		c.GetJanoTService = func() posv.TradingService {
			return eth.JanoT
		}
	...
	eth.blockchain, err = core.NewBlockChainEx(chainDb, janoTServ.GetLevelDB(), cacheConfig, eth.chainConfig, eth.engine, vmConfig)
	if err != nil {
		return nil, err
	}
...
func (s *Ethereum) GetJanoT() *janot.JanoT {
	return s.JanoT
}
...
func (s *Ethereum) GetJanoTLending() *janotlending.Lending {
	return s.Lending
}
