...
import (
	...
	"errors"
	"fmt"
	"github.com/janetachain/janetachain/janot/tradingstate"
	...
	"github.com/janetachain/janetachain/common/math"
	...
	stateDatabase "github.com/janetachain/janetachain/core/state"
...
func (b *EthApiBackend) GetEVM(ctx context.Context, msg core.Message, state *state.StateDB, janotState *tradingstate.TradingStateDB, header *types.Header, vmCfg vm.Config) (*vm.EVM, func() error, error) {
	state.SetBalance(msg.From(), math.MaxBig256)
	vmError := func() error { return nil }

	context := core.NewEVMContext(msg, header, b.eth.BlockChain(), nil)
	return vm.NewEVM(context, state, janotState, b.eth.chainConfig, vmCfg), vmError, nil
}
...
func (b *EthApiBackend) GetOrderNonce(address common.Hash) (uint64, error) {
	janotService := b.eth.GetJanoT()
	if janotService != nil {
		author, err := b.GetEngine().Author(b.CurrentBlock().Header())
		if err != nil {
			return 0, err
		}
		janotState, err := janotService.GetTradingState(b.CurrentBlock(), author)
		if err != nil {
			return 0, err
		}
		return janotState.GetNonce(address), nil
	}
	return 0, errors.New("cannot find janot service")
}

func (b *EthApiBackend) JanoTService() *janot.JanoT {
	return b.eth.JanoT
}

func (b *EthApiBackend) LendingService() *janotlending.Lending {
