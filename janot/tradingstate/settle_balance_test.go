...
func TestGetSettleBalance(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"BUY, quote is not JANETA, makerFee <= 0.001 JANETA",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
		...
		{
			"BUY, quote is not JANETA, takerFee <= 0.001 JANETA",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
		...
		{
			"BUY, quote is JANETA, makerFee <= 0.001 JANETA",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
		...
		{
			"BUY, quote is JANETA, takerFee <= 0.001 JANETA",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Bid,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
...

		{
			...
			&SettleBalance{
				Taker: TradeResult{Fee: testFee, InToken: testToken, InTotal: tradeQuantity, OutToken: common.HexToAddress(common.JanetaNativeAddress), OutTotal: tradeQuantityIncludedFee},
				Maker: TradeResult{Fee: testFee, InToken: common.HexToAddress(common.JanetaNativeAddress), InTotal: tradeQuantityExcludedFee, OutToken: testToken, OutTotal: tradeQuantity},
			},
			false,
		},
		...
		{
			"SELL, quote is not JANETA, makerFee <= 0.001 JANETA",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
		...
		{
			"SELL, quote is not JANETA, takerFee <= 0.001 JANETA",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
		...
		{
			"SELL, quote is JANETA, makerFee <= 0.001 JANETA",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(10), // feeRate 0.1%
		...
		{
			"SELL, quote is JANETA, takerFee <= 0.001 JANETA",
			GetSettleBalanceArg{
				quotePrice:        common.BasePrice,
				takerSide:         Ask,
				takerFeeRate:      big.NewInt(5), // feeRate 0.05%
...

		{
			...
			&SettleBalance{
				Maker: TradeResult{Fee: testFee, InToken: testToken, InTotal: tradeQuantity, OutToken: common.HexToAddress(common.JanetaNativeAddress), OutTotal: tradeQuantityIncludedFee},
				Taker: TradeResult{Fee: testFee, InToken: common.HexToAddress(common.JanetaNativeAddress), InTotal: tradeQuantityExcludedFee, OutToken: testToken, OutTotal: tradeQuantity},
			},
			false,
		},
	}
