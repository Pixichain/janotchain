...
import (
	...
	"errors"
	"fmt"
	"github.com/janotchain/janotchain/janotlending/lendingstate"
	"math/big"
	"sort"
	"strings"
	"time"
	...
	"github.com/janotchain/janotchain/accounts"
	"github.com/janotchain/janotchain/accounts/abi/bind"
	"github.com/janotchain/janotchain/accounts/keystore"
	"github.com/janotchain/janotchain/common"
	"github.com/janotchain/janotchain/common/hexutil"
	"github.com/janotchain/janotchain/common/math"
	"github.com/janotchain/janotchain/consensus/ethash"
	"github.com/janotchain/janotchain/consensus/posv"
	contractValidator "github.com/janotchain/janotchain/contracts/validator/contract"
	"github.com/janotchain/janotchain/core"
	"github.com/janotchain/janotchain/core/state"
	"github.com/janotchain/janotchain/core/types"
	"github.com/janotchain/janotchain/core/vm"
	"github.com/janotchain/janotchain/crypto"
	"github.com/janotchain/janotchain/log"
	"github.com/janotchain/janotchain/p2p"
	"github.com/janotchain/janotchain/params"
	"github.com/janotchain/janotchain/rlp"
...
//
// https://github.com/janotchain/janotchain/wiki/Management-APIs#personal_sign
...
//
// https://github.com/janotchain/janotchain/wiki/Management-APIs#personal_ecRecover
...
func (s *PublicBlockChainAPI) getCandidatesFromSmartContract() ([]posv.Masternode, error) {
	...
	validator, err := contractValidator.NewJanotValidator(addr, client)
	if err != nil {
		return []posv.Masternode{}, err
	}
...
func (s *PublicBlockChainAPI) doCall(ctx context.Context, args CallArgs, blockNr rpc.BlockNumber, vmCfg vm.Config, timeout time.Duration) ([]byte, uint64, bool, error) {
	...
	janotState, err := s.b.JanotxService().GetTradingState(block, author)
	if err != nil {
		return nil, 0, false, err
	}
	// Get a new instance of the EVM.
	evm, vmError, err := s.b.GetEVM(ctx, msg, statedb, janotState, header, vmCfg)
	if err != nil {
		return nil, 0, false, err
	}
...
// PublicTransactionPoolAPI exposes methods for the RPC interface
type PublicJanotXTransactionPoolAPI struct {
	b         Backend
	nonceLock *AddrLocker
}
...
// NewPublicTransactionPoolAPI creates a new RPC service with methods specific for the transaction pool.
func NewPublicJanotXTransactionPoolAPI(b Backend, nonceLock *AddrLocker) *PublicJanotXTransactionPoolAPI {
	return &PublicJanotXTransactionPoolAPI{b, nonceLock}
}
...
// The sender is responsible for signing the transaction and using the correct nonce.
func (s *PublicJanotXTransactionPoolAPI) SendOrderRawTransaction(ctx context.Context, encodedTx hexutil.Bytes) (common.Hash, error) {
...
// The sender is responsible for signing the transaction and using the correct nonce.
func (s *PublicJanotXTransactionPoolAPI) SendLendingRawTransaction(ctx context.Context, encodedTx hexutil.Bytes) (common.Hash, error) {
...
func (s *PublicJanotXTransactionPoolAPI) GetOrderTxMatchByHash(ctx context.Context, hash common.Hash) ([]*tradingstate.OrderItem, error) {
	var tx *types.Transaction
...
func (s *PublicJanotXTransactionPoolAPI) GetOrderPoolContent(ctx context.Context) interface{} {
...
func (s *PublicJanotXTransactionPoolAPI) GetOrderStats(ctx context.Context) interface{} {
...
// The sender is responsible for signing the transaction and using the correct nonce.
func (s *PublicJanotXTransactionPoolAPI) SendOrder(ctx context.Context, msg OrderMsg) (common.Hash, error) {
...
// The sender is responsible for signing the transaction and using the correct nonce.
func (s *PublicJanotXTransactionPoolAPI) SendLending(ctx context.Context, msg LendingMsg) (common.Hash, error) {
...
func (s *PublicJanotXTransactionPoolAPI) GetOrderCount(ctx context.Context, addr common.Address) (*hexutil.Uint64, error) {
...
func (s *PublicJanotXTransactionPoolAPI) GetBestBid(ctx context.Context, baseToken, quoteToken common.Address) (PriceVolume, error) {
	...
	janotService := s.b.JanotxService()
	if janotService == nil {
		return result, errors.New("JanotX service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
		return result, err
	}
	janotState, err := janotService.GetTradingState(block, author)
	if err != nil {
		return result, err
	}
	result.Price, result.Volume = janotState.GetBestBidPrice(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
...
func (s *PublicJanotXTransactionPoolAPI) GetBestAsk(ctx context.Context, baseToken, quoteToken common.Address) (PriceVolume, error) {
	result := PriceVolume{}
	block := s.b.CurrentBlock()
	if block == nil {
		return result, errors.New("Current block not found")
	...
	result.Price, result.Volume = janotState.GetBestAskPrice(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if result.Price.Sign() == 0 {
...
func (s *PublicJanotXTransactionPoolAPI) GetBidTree(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]tradingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
	...
	janotService := s.b.JanotxService()
	if janotService == nil {
		return nil, errors.New("JanotX service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
		return nil, err
	...
	result, err := janotState.DumpBidTrie(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicJanotXTransactionPoolAPI) GetPrice(ctx context.Context, baseToken, quoteToken common.Address) (*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	price := janotState.GetLastPrice(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
...
func (s *PublicJanotXTransactionPoolAPI) GetLastEpochPrice(ctx context.Context, baseToken, quoteToken common.Address) (*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	price := janotState.GetMediumPriceBeforeEpoch(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if price == nil || price.Sign() == 0 {
		return common.Big0, errors.New("Order book's price not found")
	}
	return price, nil
...
func (s *PublicJanotXTransactionPoolAPI) GetCurrentEpochPrice(ctx context.Context, baseToken, quoteToken common.Address) (*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	price, _ := janotState.GetMediumPriceAndTotalAmount(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if price == nil || price.Sign() == 0 {
		return common.Big0, errors.New("Order book's price not found")
	}
	return price, nil
...
func (s *PublicJanotXTransactionPoolAPI) GetAskTree(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]tradingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := janotState.DumpAskTrie(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicJanotXTransactionPoolAPI) GetOrderById(ctx context.Context, baseToken, quoteToken common.Address, orderId uint64) (interface{}, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	orderitem := janotState.GetOrder(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken), orderIdHash)
...
func (s *PublicJanotXTransactionPoolAPI) GetTradingOrderBookInfo(ctx context.Context, baseToken, quoteToken common.Address) (*tradingstate.DumpOrderBookInfo, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := janotState.DumpOrderBookInfo(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicJanotXTransactionPoolAPI) GetLiquidationPriceTree(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]tradingstate.DumpLendingBook, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := janotState.DumpLiquidationPriceTrie(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicJanotXTransactionPoolAPI) GetInvestingTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	if lendingService == nil {
		return nil, errors.New("JanotX Lending service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
		return nil, err
...
func (s *PublicJanotXTransactionPoolAPI) GetBorrowingTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicJanotXTransactionPoolAPI) GetLendingOrderBookInfo(tx context.Context, lendingToken common.Address, term uint64) (*lendingstate.DumpOrderBookInfo, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicJanotXTransactionPoolAPI) getLendingOrderTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.LendingItem, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicJanotXTransactionPoolAPI) GetLendingTradeTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.LendingTrade, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicJanotXTransactionPoolAPI) GetLiquidationTimeTree(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]lendingstate.DumpOrderList, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicJanotXTransactionPoolAPI) GetLendingOrderCount(ctx context.Context, addr common.Address) (*hexutil.Uint64, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicJanotXTransactionPoolAPI) GetBestInvesting(ctx context.Context, lendingToken common.Address, term uint64) (InterestVolume, error) {
	...
	lendingService := s.b.LendingService()
	if lendingService == nil {
		return result, errors.New("JanotX Lending service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
		return result, err
...
func (s *PublicJanotXTransactionPoolAPI) GetBestBorrowing(ctx context.Context, lendingToken common.Address, term uint64) (InterestVolume, error) {
	result := InterestVolume{}
	block := s.b.CurrentBlock()
	if block == nil {
		return result, errors.New("Current block not found")
...
func (s *PublicJanotXTransactionPoolAPI) GetBids(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := janotState.GetBids(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicJanotXTransactionPoolAPI) GetAsks(ctx context.Context, baseToken, quoteToken common.Address) (map[*big.Int]*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
	...
	result, err := janotState.GetAsks(tradingstate.GetTradingOrderBookHash(baseToken, quoteToken))
	if err != nil {
		return nil, err
	}
	return result, nil
...
func (s *PublicJanotXTransactionPoolAPI) GetInvests(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicJanotXTransactionPoolAPI) GetBorrows(ctx context.Context, lendingToken common.Address, term uint64) (map[*big.Int]*big.Int, error) {
	block := s.b.CurrentBlock()
	if block == nil {
		return nil, errors.New("Current block not found")
	}
...
func (s *PublicJanotXTransactionPoolAPI) GetLendingTxMatchByHash(ctx context.Context, hash common.Hash) ([]*lendingstate.LendingItem, error) {
	var tx *types.Transaction
	if tx, _, _, _ = core.GetTransaction(s.b.ChainDb(), hash); tx == nil {
		if tx = s.b.GetPoolTransaction(hash); tx == nil {
...
// GetLiquidatedTradesByTxHash returns trades which closed by JanotX protocol at the tx of the give hash
func (s *PublicJanotXTransactionPoolAPI) GetLiquidatedTradesByTxHash(ctx context.Context, hash common.Hash) (lendingstate.FinalizedResult, error) {
	var tx *types.Transaction
	if tx, _, _, _ = core.GetTransaction(s.b.ChainDb(), hash); tx == nil {
		if tx = s.b.GetPoolTransaction(hash); tx == nil {
...
func (s *PublicJanotXTransactionPoolAPI) GetLendingOrderById(ctx context.Context, lendingToken common.Address, term uint64, orderId uint64) (lendingstate.LendingItem, error) {
	...
	lendingService := s.b.LendingService()
	if lendingService == nil {
		return lendingItem, errors.New("JanotX Lending service not found")
	}
	author, err := s.b.GetEngine().Author(block.Header())
	if err != nil {
...
func (s *PublicJanotXTransactionPoolAPI) GetLendingTradeById(ctx context.Context, lendingToken common.Address, term uint64, tradeId uint64) (lendingstate.LendingTrade, error) {
