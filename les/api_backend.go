...
import (
	...
	"github.com/janotchain/janotchain/light"
...
func (b *LesApiBackend) GetEVM(ctx context.Context, msg core.Message, state *state.StateDB, janotState *tradingstate.TradingStateDB, header *types.Header, vmCfg vm.Config) (*vm.EVM, func() error, error) {
	state.SetBalance(msg.From(), math.MaxBig256)
	context := core.NewEVMContext(msg, header, b.eth.blockchain, nil)
	return vm.NewEVM(context, state, janotState, b.eth.chainConfig, vmCfg), state.Error, nil
}
...
func (b *LesApiBackend) TomoxService() *janot.TomoX {
	return nil
}

func (b *LesApiBackend) LendingService() *janotlending.Lending {
	return nil
}
