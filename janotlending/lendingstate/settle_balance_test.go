...
func TestGetSettleBalance(t *testing.T) {
	...
	type GetSettleBalanceArg struct {
		isJanoTLendingFork     bool
		takerSide              string
		lendTokenJANETAPrice     *big.Int
	...
	tests := []struct {
		...
		{
			"LendToken is JANETA, quantity too small, taker BORROW",
			GetSettleBalanceArg{
				true,
				Borrowing,
				common.BasePrice,
		...
		{
			"LendToken is not JANETA, quantity too small, taker BORROW",
			GetSettleBalanceArg{
				true,
				Borrowing,
				common.BasePrice,
		...
		{
			"LendToken is not JANETA, no error, taker BORROW",
			GetSettleBalanceArg{
				true,
				Borrowing,
				common.BasePrice,
		...
		{
			"LendToken is not JANETA, no error, taker INVEST",
			GetSettleBalanceArg{
				true,
				Investing,
				common.BasePrice,
		...
		{
			"LendToken is JANETA, no error, taker invest",
			GetSettleBalanceArg{
				true,
				Investing,
				common.BasePrice,
		...
		{
			"LendToken is JANETA, no error, taker Borrow",
			GetSettleBalanceArg{
				true,
				Borrowing,
				common.BasePrice,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := GetSettleBalance(tt.args.isJanoTLendingFork, tt.args.takerSide, tt.args.lendTokenJANETAPrice, tt.args.collateralPrice, tt.args.depositRate, tt.args.borrowFeeRate, tt.args.lendingToken, tt.args.collateralToken, tt.args.lendTokenDecimal, tt.args.collateralTokenDecimal, tt.args.quantityToLend)
