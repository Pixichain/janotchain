...
func Test_getCancelFee(t *testing.T) {
	janot := janot.New(&janot.DefaultConfig)
	...
	janot.SetTokenDecimal(testTokenB, new(big.Int).Exp(big.NewInt(10), big.NewInt(8), nil))
	...
	tests := []struct {
		...
		// COLLATERAL TOKEN: JANETA

		// zero fee test: LEND
		{
			"TokenA/JANETAzero fee test: LEND",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
		...
		// zero fee test: BORROW
		{
			"TokenA/JANETA zero fee test: BORROW",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
					LendingToken:    testTokenA,
		...
		// test getCancelFee: LEND
		{
			"TokenA/JANETA test getCancelFee:: LEND",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    testTokenA,
		...
		// test getCancelFee:: BORROW
		{
			"TokenA/JANETA test getCancelFee:: BORROW",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    testTokenA,
		...
		// LENDING TOKEN: JANETA
		// COLLATERAL TOKEN: testTokenA

		// zero fee test: LEND
		{
			"JANETA/TokenA zero fee test: LEND",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
		...
		// zero fee test: BORROW
		{
			"JANETA/TokenA zero fee test: BORROW",
			CancelFeeArg{
				borrowFeeRate: common.Big0,
				order: &lendingstate.LendingItem{
					LendingToken:    common.HexToAddress(common.TomoNativeAddress),
		...
		// test getCancelFee: LEND
		{
			"JANETA/TokenA  test getCancelFee:: LEND",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    common.HexToAddress(common.TomoNativeAddress),
		...
		// test getCancelFee:: BORROW
		{
			"JANETA/TokenA  test getCancelFee:: BORROW",
			CancelFeeArg{
				borrowFeeRate: new(big.Int).SetUint64(30), // 30/10000= 0.3%
				order: &lendingstate.LendingItem{
					LendingToken:    common.HexToAddress(common.TomoNativeAddress),
